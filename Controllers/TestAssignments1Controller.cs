...
{
    public class TestAssignments1Controller : Controller
    {
        private readonly EmployeeAssessmentContext _context;

        public TestAssignments1Controller(EmployeeAssessmentContext context)
        {
            _context = context;
        }

        // GET: TestAssignments1
        ...
        // GET: TestAssignments1/Details/5
        ...
        // POST: TestAssignments1/Delete/5
